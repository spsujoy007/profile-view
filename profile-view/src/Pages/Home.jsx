            ...
            <div className='min-h-screen'>
            {
                ...
                <div className='h-screen px-5 md:px-0 flex items-center justify-center flex-col'>
                    ...
                    <div className='flex items-center gap-3'>
                        <button onClick={() => navigate('/editprofile')} className='px-5 py-2 md:w-[250px] btn-bg rounded-md border-[1px] border-[#242424] uppercase mt-10'>Arrange Profile</button>
                        {
                            username &&
                        <button onClick={() => navigate(`/profile/${user.username}`)} className='px-5 py-2 md:w-[250px] btn-bg rounded-md border-[1px] border-[#242424] uppercase mt-10'>My Profile</button>
                        }
                    </div>
                </div>
                :
