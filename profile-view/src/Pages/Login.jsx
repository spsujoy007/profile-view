                    ...
                    <div className='border-[1px] border-[#262626] flex items-center md:flex-row flex-col'>
                        <img className='md:w-[30%]' src={loginboy} alt="" />
                            ...
                            <div className='w-full'>
                                    ...
                                    <input required name='username' className='text-md outline-none py-2 md:w-[90%] w-full  bg-transparent border-b-[1px] border-[#262626] mb-5' placeholder='type your user name here...' id='username' type="text" /> 
                                    <br />
